    ...
    <div class="page__container">
        <div class="left-side">
            <div class="text-center mt-4">
                <a href="/">
                    <img height="50" src="/assets/images/logo/todua-light.svg" />
                </a>
            </div>
            <h4 class="room__title mt-4 p-3">{{ $room->name }}</h4>

            <h4 class="room__title_v2 mt-4 p-3">არჩეული თარიღი</h4>
            <div class="chosen_date">10 აგვ 2023 15:30</div>
        </div>
