...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/booking/edit.css') }}">
@endsection

@section('script')
    <script src="{{ asset('js/admin/main.js') }}"></script>
    <script src="{{ asset('js/admin/booking/edit.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="edit__page__container">
        ...
        <div class="form__container">
            ...
            <form action="{{ route('booking_update',$booking->id) }}" method="POST" class="edit__form"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="full_container">
                    ...
                    <div class="edit__submit__container">
                        ...
                        <a id="edit__booking" href="javascript:void(0)"  class="edit__btn">
