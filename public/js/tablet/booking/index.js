        ...
        if (response.room) {
            ...
            jQuery('#booking_room_calendar').datetimepicker({
                ...
                onSelectDate: function (date) {
                    ...
                    const calendar__box = document.getElementById('calendar__box');
                    calendar__box.classList.remove('full');
                    calendar__box.classList.add('half');
                    ...
                    $.ajax({
                        ...
                        url: room_id  + '/room_booking_info/' + selected_date,
                        method: 'GET',
                        dataType: 'json',
                        success: function (response) {
                            ...
                            time_boxes.forEach(time_box => {
                                time_box.addEventListener("click", function () {
                                    ...
                                    const create__container = document.getElementById('create__container');
                                    create__container.classList.remove('hide');
                                    create__container.classList.add('show');
